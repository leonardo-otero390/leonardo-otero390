...
[![WhatsApp](https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://api.whatsapp.com/send?phone=5567992727452&text=Olá,%20meu%20amigo!)

## Sobre Mim :speech_balloon:

Olá! Meu nome é Leonardo, tenho 23 anos e faço Engenharia Elétrica pela UFMS. Meu objetivo é tornar o mundo um lugar melhor.

Estou participando da [Formação Driven de programação web](https://www.driven.com.br/) onde já realizei 14 projetos Front-End e Back-End feitos com as principais tecnologias WEB: HTML5, CSS3, Javascript, ReactJS, NodeJS, ExpressJS e PostgreSQL. Além de Deploy para aplicações Full-Stack em produção com Heroku, testes automatizados com Jest e projetos em grupo utilizando Metodologias Ágeis (Scrum), Git, Trello, Slack, Zoom, Pair programming e Code Review.
